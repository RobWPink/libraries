...
public:
   ...
   */
  bool checkSendCmd(const char* cmd = NULL, const char* resp = NULL, uint32_t timeout = 2500);
   ...
   */
  uint16_t readBuffer(char* buffer, uint16_t maxSize, uint32_t timeout = 2500);
